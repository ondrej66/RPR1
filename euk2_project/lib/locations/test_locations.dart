...
Icon getIconByType(TestLocationType type) {
  switch (type) {
    case TestLocationType.wc:
      return const Icon(Icons.wc, color: Colors.blue, size: 36,);
    case TestLocationType.platform:
      return const Icon(Icons.accessible_sharp, color: Colors.red, size: 36,);
    case TestLocationType.hospital:
      return const Icon(Icons.local_hospital, color: Colors.green, size: 36,);
  }
}
